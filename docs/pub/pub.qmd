...
It then examines how prompt language affects performance, identifies cross-linguistic patterns, and analyzes model behavior across French and English. 
...
A major limitation of this project is that the manual annotation was done by a single coder with a small sample of sentences.
This limits the reliability of the ground truth dataset, as the inter-annotator agreement was not measured.
