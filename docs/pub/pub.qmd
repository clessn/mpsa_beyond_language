...
<!-- NOTE: Ajouter source et dire que la majorité des données d'entrainement de LLAMA c'est English -->
...
This paper addresses a fundamental question in this domain: Can open and closed weights general purpose foundational LLMs accurately evaluate sentiment in non-English texts?
...
While close weights models such as those offered by Google or Anthropic have received substantial attention in multilingual contexts, open weights LLMs present both unique challenges and opportunities. 
<!-- NOTE: Peut être une note de bas de page qui explique pk sont pas open source mais open weights -->
...
<!--NOTE: citation de vibe coding -->
We vibe-coded a Python-based web scraper using Selenium WebDriver to extract article content more conveniently from the database. 
...
<!-- NOTE: ajouter citation Duval et Petry  -->
